...
$( document ).ready(  function() {
				...
				//console.log("debut "+Date.today().last().monday()+" fin "+Date.today().next().monday());
	        		...
	        		function affiche_agenda(rendezvous,choix) {
	        			...
	        			$('#calendar').weekCalendar({
	        			      ...
	        			      changedate:function($calendar, newDate){
	        			    	  $.mobile.loading( 'show', {
	        							 ...
	        							 theme: "a"
	        				        		...
	        				        		$.ajax({	
	        									...
	        									cache: false,
	        									data:  {
	        				        				debut : newDate.clone().getTime(), fin : newDate.clone().next().monday().getTime()
	        									       },	
	        									success: function(data){
	        									$.mobile.loading('hide');	        									
								...
								//	recherche_donne_agenda(newDate.last().monday(),newDate.next().monday(),$('#data_source').val());
	        			      ...
	        			      data: function(start, end, callback) {
							          ...
							          for(var i = 0; i < mon_array.length; ++ i){
							        	  mon_array[i].start = mon_array[i].start;
							        	  mon_array[i].end = mon_array[i].end;
	        			      ...
	        			      eventNew: function(calEvent, $event) {
	        			        displayMessage('<strong>Added event</strong><br/>Start: ' + calEvent.start + '<br/>End: ' + calEvent.end);
	        			        		...
	        			        		if($('#data_source').val()=='<?php echo $_SESSION['login'];?>'){ 
...
<?php $vetos2 = json_decode($vetos, true);?>
<fieldset class="ui-grid-c">
        ...
        <div class="ui-block-d">   
        		 <strong><?php echo TXT_AGENDA_SELECTORGANIZER; ?></strong>  
