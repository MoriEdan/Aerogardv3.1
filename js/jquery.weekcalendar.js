      ...
      _renderCalendarButtons: function($calendarContainer) {
        ...
        if (options.buttons) {
          ...
          //  calendarNavHtml += '</div>';
              ...
              calendarNavHtml += '<div class=\"wc-display\"></div>';
			  calendarNavHtml += '<div class=\"wc-nav\">';
              calendarNavHtml += '<fieldset class=\"ui-grid-c\">';
			  calendarNavHtml += '<div class=\"ui-block-a\" style=\"width:10%\">';		  
                calendarNavHtml += '<button class=\"wc-prev\">' + options.buttonText.lastWeek + '</button>';
				calendarNavHtml += '</div>';
				calendarNavHtml += '<div class=\"ui-block-b\" style=\"width:10%\">';
                calendarNavHtml += '<button class=\"wc-today\">' + options.buttonText.today + '</button>';
				calendarNavHtml += '</div>';
				calendarNavHtml += '<div class=\"ui-block-c\" style=\"width:10%\">'
                calendarNavHtml += '<button class=\"wc-next\">' + options.buttonText.nextWeek + '</button>';
				calendarNavHtml += '</div>';
				calendarNavHtml += '<div class=\"ui-block-c\" style=\"width:10%\">'
                calendarNavHtml += '<h1 class=\"wc-title\"></h1>';
				calendarNavHtml += '</div>';
				calendarNavHtml += '<div class=\"ui-block-d\" style=\"width:10%\">'
				calendarNavHtml += '</div>';
              calendarNavHtml += '</fieldset>';
			  calendarNavHtml += '</div>';
...
//              calendarHeaderHtml+=    "</div>";
  ...
  TODO    if total height for an hour is less than 11px, there is a display problem.
      ...
      _loadCalEvents: function(dateWithinWeek) {
          ...
          console.log('date '+options.date.clone().last().monday().getTime()+' option'+options.date+' option min'+options.minDate+' option max'+options.maxDate+' min max '+this._fixMinMaxDate(dateWithinWeek || options.date))
      ...
      _cleanDate: function(d) {
          if (typeof d === 'string') {
            ...
            console.log("date "+d)
            console.log("date2 "+Date.parse(d))
